...
public abstract class Item implements Drawable, SearchTreeObject, ObjectInfoPanel.Printable, UndoableObjects.Storable, Serializable
{
    ...
    public int compareTo(Object p_other)
    {
        ...
        {
            lresult = ((Item) p_other).id_no - id_no;
            if(lresult<0)
            {
                result=-1;
            }
     ...
     */
    public abstract Item copy(long p_id_no);
    ...
    Item(int[] p_net_no_arr, int p_clearance_type, long p_id_no,
