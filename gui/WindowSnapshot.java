...
public class WindowSnapshot extends BoardSavableSubWindow
{
    ...
    public boolean read(java.io.ObjectInputStream p_object_stream)
    {
        try
        {
            ...
            String next_default_name = "snapshot " + (Integer.valueOf(snapshot_count + 1)).toString();  //Ontobus
    ...
    void goto_selected()
    {
        ...
        if (index >= 0 && list_model.getSize() > index)
        {
            ...
            board_frame.highlight_selected_button();
    ...
    private class AddListener implements java.awt.event.ActionListener
    {
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            if (new_snapshot != null)
            {
                ...
                String next_default_name = resources.getString("snapshot") + " " + (Integer.valueOf(snapshot_count + 1)).toString();  //Ontobus
