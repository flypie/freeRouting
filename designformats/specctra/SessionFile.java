...
public class SessionFile
{
            ...
            IndentFileWriter p_file, board.Component p_component) throws java.io.IOException
    {
        ...
        p_file.write((Integer.valueOf(rotation).toString())); //Ontobus
            ...
            throws java.io.IOException
    {
        ...
        p_file.write(" ");
        p_file.write((Integer.valueOf(p_width)).toString()); //Ontobus
        int corner_count = p_coors.length/ 2;
        for (int i = 0; i < corner_count; ++i)
        {
            p_file.new_line();
            p_file.write(Integer.valueOf(p_coors[2 * i]).toString()); //Ontobus
            p_file.write(" ");
            p_file.write(Integer.valueOf(p_coors[2 * i + 1]).toString()); //Ontobus
        }
        p_file.end_scope();
    }
